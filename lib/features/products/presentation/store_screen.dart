                                                                        ...
                                                                        return GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            colorsSelected.value =
                                                                                state.colors[index];
                                                                            productsBloc.add(GetProductsEvent(params: GetProductsParams(search: searchController.text, color: colorsSelected.value)));
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            width:
                                                                                75,
                                                                            decoration:
                                                                                BoxDecoration(color: state.colors[index] == value ? Colors.grey : null, borderRadius: BorderRadius.circular(25)),
                                                                            padding:
